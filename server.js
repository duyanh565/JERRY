...
// Xoá sạch admin cũ (khi quên cả username lẫn password) — dùng 1 lần rồi setup lại từ đầu
...
// Nhận cả multipart (FormData) lẫn JSON base64
app.post('/api/patch-file', (req, res, next) => {
  ...
  // Trả JSON chứa download ID — client dùng /api/download/:id để tải
...
app.get('/api/download/:id', (req, res) => {
  ...
  downloadStore.delete(req.params.id); // chỉ cho tải 1 lần
